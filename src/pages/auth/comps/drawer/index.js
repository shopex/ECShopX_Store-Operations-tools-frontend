        ...
        <View className='body'>
          ...
          <ScrollView className='body-content'>
            ...
            <View className='body-content-text'>
              <Text className='text'>
                以下内容是《商派云店使用协议》及《商派云店隐私政策》，在你注册商派云店前请务必审慎阅读、充分理解协议中相关条款内容。《商派云店使用协议》包括接受条款；服务说明；你的注册义务；用户账号、密码及安全；用户个人信息保护；提供者之责任；服务变更、中断或终止；担保与保证；用户行为；知识产权；用户专属权利；国际使用之特别告知；未成年人使用条款；一般条款。《商派云店隐私政策》包括我们如何收集和使用你的个人信息；我们如何使用Cookie 和同类技术；我们如何共享、转让、公开披露你的个人信息；我们如何保护你的个人信息；你的权利 ；关于儿童的个人信息；你的个人信息如何在全球范围转移；本政策如何更新；如何联系我们。 你一旦注册商派云店，即视为你已了解并同意《商派云店使用协议》及《商派云店隐私政策》的各项内容。
              </Text>
            </View>
            <View className='body-content-title'>
